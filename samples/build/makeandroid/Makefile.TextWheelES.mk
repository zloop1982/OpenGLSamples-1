...
TextWheelES_cpp_debug_dep    = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.cpp, %.cpp.debug.P, $(TextWheelES_cppfiles)))))
TextWheelES_cc_debug_dep    = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.cc, %.cc.debug.P, $(TextWheelES_ccfiles)))))
TextWheelES_c_debug_dep      = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.c, %.c.debug.P, $(TextWheelES_cfiles)))))
...
TextWheelES_cpp_release_dep    = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.cpp, %.cpp.release.P, $(TextWheelES_cppfiles)))))
TextWheelES_cc_release_dep    = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.cc, %.cc.release.P, $(TextWheelES_ccfiles)))))
TextWheelES_c_release_dep      = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.c, %.c.release.P, $(TextWheelES_cfiles)))))
...
TextWheelES_debug_hpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/4.8/include
TextWheelES_debug_hpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/4.8/libs/armeabi-v7a/include
TextWheelES_debug_hpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/4.8/include/backward
...
TextWheelES_debug_lpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/4.8/libs/armeabi-v7a
TextWheelES_debug_lpaths    += ./../../../extensions/externals/lib/Tegra-Android
TextWheelES_debug_lpaths    += ./../../../extensions/lib/Tegra-Android
...
TextWheelES_debug_cflags  += -fpic -fPIC -ffunction-sections -funwind-tables -fstack-protector -no-canonical-prefixes -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fstrict-aliasing -funswitch-loops -finline-limit=300
...
TextWheelES_debug_cppflags  += -fpic -fPIC -ffunction-sections -funwind-tables -fstack-protector -no-canonical-prefixes -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fstrict-aliasing -funswitch-loops -finline-limit=300
TextWheelES_debug_cppflags  += -funwind-tables -O0 -g -ggdb -fno-omit-frame-pointer
...
antbuild_TextWheelES_debug: preantbuild_TextWheelES_debug
	cd ./../../nvpr/TextWheelES; dos2unix $(ANT_TOOL); JAVA_HOME=$(JAVA_HOME) $(ANT_TOOL) debug
mainbuild_TextWheelES_debug: prebuild_TextWheelES_debug $(TextWheelES_debug_bin)
prebuild_TextWheelES_debug:

$(TextWheelES_debug_bin): $(TextWheelES_debug_obj) build_cg4cpp_debug build_Half_debug build_NvAppBase_debug build_NvAssetLoader_debug build_NvEGLUtil_debug build_NvGamepad_debug build_NvGLUtils_debug build_NvModel_debug build_NvUI_debug 
	mkdir -p `dirname ./../../nvpr/TextWheelES/libs/armeabi-v7a/libTextWheelES.so`
	$(CXX) -shared $(TextWheelES_debug_obj) $(TextWheelES_debug_lflags) -lc -o $@ 
...
$(TextWheelES_debug_cpp_o): $(TextWheelES_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(TextWheelES_debug_objsdir),, $@))), $(TextWheelES_cppfiles))))))
	cp $(TextWheelES_debug_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(TextWheelES_debug_objsdir),, $@))), $(TextWheelES_cppfiles))))).debug.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(TextWheelES_debug_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(TextWheelES_debug_objsdir),, $@))), $(TextWheelES_cppfiles))))).debug.P; \
...
$(TextWheelES_debug_c_o): $(TextWheelES_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(TextWheelES_debug_objsdir),, $@))), $(TextWheelES_cfiles))))))
	cp $(TextWheelES_debug_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(TextWheelES_debug_objsdir),, $@))), $(TextWheelES_cfiles))))).debug.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(TextWheelES_debug_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(TextWheelES_debug_objsdir),, $@))), $(TextWheelES_cfiles))))).debug.P; \
	  rm -f $(TextWheelES_debug_DEPDIR).d
...
TextWheelES_release_hpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/4.8/include
TextWheelES_release_hpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/4.8/libs/armeabi-v7a/include
TextWheelES_release_hpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/4.8/include/backward
...
TextWheelES_release_lpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/4.8/libs/armeabi-v7a
TextWheelES_release_lpaths    += ./../../../extensions/externals/lib/Tegra-Android
TextWheelES_release_lpaths    += ./../../../extensions/lib/Tegra-Android
...
TextWheelES_release_cflags  += -fpic -fPIC -ffunction-sections -funwind-tables -fstack-protector -no-canonical-prefixes -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fstrict-aliasing -funswitch-loops -finline-limit=300
...
TextWheelES_release_cppflags  += -fpic -fPIC -ffunction-sections -funwind-tables -fstack-protector -no-canonical-prefixes -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fstrict-aliasing -funswitch-loops -finline-limit=300
TextWheelES_release_cppflags  += -funwind-tables -O2 -fno-omit-frame-pointer
...
$(TextWheelES_release_bin): $(TextWheelES_release_obj) build_cg4cpp_release build_Half_release build_NvAppBase_release build_NvAssetLoader_release build_NvEGLUtil_release build_NvGamepad_release build_NvGLUtils_release build_NvModel_release build_NvUI_release 
	mkdir -p `dirname ./../../nvpr/TextWheelES/libs/armeabi-v7a/libTextWheelES.so`
	$(CXX) -shared $(TextWheelES_release_obj) $(TextWheelES_release_lflags) -lc -o $@ 
	$(ECHO) building $@ complete!
...
$(TextWheelES_release_cpp_o): $(TextWheelES_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(TextWheelES_release_objsdir),, $@))), $(TextWheelES_cppfiles))))))
	cp $(TextWheelES_release_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(TextWheelES_release_objsdir),, $@))), $(TextWheelES_cppfiles))))).release.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(TextWheelES_release_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(TextWheelES_release_objsdir),, $@))), $(TextWheelES_cppfiles))))).release.P; \
...
$(TextWheelES_release_c_o): $(TextWheelES_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(TextWheelES_release_objsdir),, $@))), $(TextWheelES_cfiles))))))
	cp $(TextWheelES_release_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(TextWheelES_release_objsdir),, $@))), $(TextWheelES_cfiles))))).release.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(TextWheelES_release_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(TextWheelES_release_objsdir),, $@))), $(TextWheelES_cfiles))))).release.P; \
	  rm -f $(TextWheelES_release_DEPDIR).d
