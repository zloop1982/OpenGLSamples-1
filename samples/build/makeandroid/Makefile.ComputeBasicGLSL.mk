...
ComputeBasicGLSL_debug_defines   += ANDROID
ComputeBasicGLSL_debug_defines   += GL_API_LEVEL_ES3_1
...
ComputeBasicGLSL_debug_libraries += GLESv3
...
ComputeBasicGLSL_debug_cflags  += -fpic -fPIC -ffunction-sections -funwind-tables -fstack-protector -no-canonical-prefixes -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fstrict-aliasing -funswitch-loops -finline-limit=300
...
ComputeBasicGLSL_debug_cppflags  += -fpic -fPIC -ffunction-sections -funwind-tables -fstack-protector -no-canonical-prefixes -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fstrict-aliasing -funswitch-loops -finline-limit=300
...
ComputeBasicGLSL_debug_bin      := ./../../es3aep-kepler/ComputeBasicGLSL/libs/armeabi-v7a/libComputeBasicGLSL.so
...
antbuild_ComputeBasicGLSL_debug: preantbuild_ComputeBasicGLSL_debug
	cd ./../../es3aep-kepler/ComputeBasicGLSL; dos2unix $(ANT_TOOL); JAVA_HOME=$(JAVA_HOME) $(ANT_TOOL) debug
...
$(ComputeBasicGLSL_debug_bin): $(ComputeBasicGLSL_debug_obj) build_Half_debug build_NvAppBase_debug build_NvAssetLoader_debug build_NvEGLUtil_debug build_NvGamepad_debug build_NvGLUtils_debug build_NvModel_debug build_NvUI_debug 
	mkdir -p `dirname ./../../es3aep-kepler/ComputeBasicGLSL/libs/armeabi-v7a/libComputeBasicGLSL.so`
...
ComputeBasicGLSL_release_defines   += ANDROID
ComputeBasicGLSL_release_defines   += GL_API_LEVEL_ES3_1
...
ComputeBasicGLSL_release_libraries += GLESv3
...
ComputeBasicGLSL_release_cflags  += -fpic -fPIC -ffunction-sections -funwind-tables -fstack-protector -no-canonical-prefixes -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fstrict-aliasing -funswitch-loops -finline-limit=300
...
ComputeBasicGLSL_release_cppflags  += -fpic -fPIC -ffunction-sections -funwind-tables -fstack-protector -no-canonical-prefixes -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fstrict-aliasing -funswitch-loops -finline-limit=300
...
ComputeBasicGLSL_release_bin      := ./../../es3aep-kepler/ComputeBasicGLSL/libs/armeabi-v7a/libComputeBasicGLSL.so
