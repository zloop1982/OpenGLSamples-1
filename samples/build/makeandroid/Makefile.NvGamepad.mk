...
NvGamepad_cppfiles   += ./../../../extensions/src/NvGamepad/NvGamepadAndroid.cpp
NvGamepad_cppfiles   += ./../../../extensions/src/NvGamepad/NvGamepadLinux.cpp
NvGamepad_cppfiles   += ./../../../extensions/src/NvGamepad/NvGamepadXInput.cpp
...
NvGamepad_debug_hpaths    += ./../../../extensions/src/NvGamepad
NvGamepad_debug_hpaths    += ./../../../extensions/include
NvGamepad_debug_hpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/platforms/android-14/arch-arm/usr/include
NvGamepad_debug_hpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/4.8/include
NvGamepad_debug_hpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/4.8/libs/armeabi-v7a/include
NvGamepad_debug_hpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/4.8/include/backward
...
NvGamepad_debug_defines   += GL_API_LEVEL_ES2
...
NvGamepad_debug_bin      := ./../../../extensions/lib/Tegra-Android/libNvGamepadD.a
...
$(NvGamepad_debug_bin): $(NvGamepad_debug_obj) 
	mkdir -p `dirname ./../../../extensions/lib/Tegra-Android/libNvGamepadD.a`
...
NvGamepad_release_hpaths    += ./../../../extensions/src/NvGamepad
NvGamepad_release_hpaths    += ./../../../extensions/include
NvGamepad_release_hpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/platforms/android-14/arch-arm/usr/include
NvGamepad_release_hpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/4.8/include
NvGamepad_release_hpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/4.8/libs/armeabi-v7a/include
NvGamepad_release_hpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/4.8/include/backward
...
NvGamepad_release_defines   += GL_API_LEVEL_ES2
...
NvGamepad_release_bin      := ./../../../extensions/lib/Tegra-Android/libNvGamepad.a
...
$(NvGamepad_release_bin): $(NvGamepad_release_obj) 
	mkdir -p `dirname ./../../../extensions/lib/Tegra-Android/libNvGamepad.a`
