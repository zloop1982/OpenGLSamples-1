...
TigerWarpES_cpp_debug_dep    = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.cpp, %.cpp.debug.P, $(TigerWarpES_cppfiles)))))
TigerWarpES_cc_debug_dep    = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.cc, %.cc.debug.P, $(TigerWarpES_ccfiles)))))
TigerWarpES_c_debug_dep      = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.c, %.c.debug.P, $(TigerWarpES_cfiles)))))
...
TigerWarpES_cpp_release_dep    = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.cpp, %.cpp.release.P, $(TigerWarpES_cppfiles)))))
TigerWarpES_cc_release_dep    = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.cc, %.cc.release.P, $(TigerWarpES_ccfiles)))))
TigerWarpES_c_release_dep      = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.c, %.c.release.P, $(TigerWarpES_cfiles)))))
...
TigerWarpES_debug_hpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/4.8/include
TigerWarpES_debug_hpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/4.8/libs/armeabi-v7a/include
TigerWarpES_debug_hpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/4.8/include/backward
...
TigerWarpES_debug_lpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/4.8/libs/armeabi-v7a
TigerWarpES_debug_lpaths    += ./../../../extensions/externals/lib/Tegra-Android
TigerWarpES_debug_lpaths    += ./../../../extensions/lib/Tegra-Android
...
TigerWarpES_debug_cflags  += -fpic -fPIC -ffunction-sections -funwind-tables -fstack-protector -no-canonical-prefixes -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fstrict-aliasing -funswitch-loops -finline-limit=300
...
TigerWarpES_debug_cppflags  += -fpic -fPIC -ffunction-sections -funwind-tables -fstack-protector -no-canonical-prefixes -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fstrict-aliasing -funswitch-loops -finline-limit=300
TigerWarpES_debug_cppflags  += -funwind-tables -O0 -g -ggdb -fno-omit-frame-pointer
...
antbuild_TigerWarpES_debug: preantbuild_TigerWarpES_debug
	cd ./../../nvpr/TigerWarpES; dos2unix $(ANT_TOOL); JAVA_HOME=$(JAVA_HOME) $(ANT_TOOL) debug
mainbuild_TigerWarpES_debug: prebuild_TigerWarpES_debug $(TigerWarpES_debug_bin)
prebuild_TigerWarpES_debug:

$(TigerWarpES_debug_bin): $(TigerWarpES_debug_obj) build_cg4cpp_debug build_Half_debug build_NvAppBase_debug build_NvAssetLoader_debug build_NvEGLUtil_debug build_NvGamepad_debug build_NvGLUtils_debug build_NvModel_debug build_NvUI_debug 
	mkdir -p `dirname ./../../nvpr/TigerWarpES/libs/armeabi-v7a/libTigerWarpES.so`
	$(CXX) -shared $(TigerWarpES_debug_obj) $(TigerWarpES_debug_lflags) -lc -o $@ 
...
$(TigerWarpES_debug_cpp_o): $(TigerWarpES_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(TigerWarpES_debug_objsdir),, $@))), $(TigerWarpES_cppfiles))))))
	cp $(TigerWarpES_debug_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(TigerWarpES_debug_objsdir),, $@))), $(TigerWarpES_cppfiles))))).debug.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(TigerWarpES_debug_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(TigerWarpES_debug_objsdir),, $@))), $(TigerWarpES_cppfiles))))).debug.P; \
...
$(TigerWarpES_debug_c_o): $(TigerWarpES_debug_objsdir)/%.o:
	...
	mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(TigerWarpES_debug_objsdir),, $@))), $(TigerWarpES_cfiles))))))
	cp $(TigerWarpES_debug_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(TigerWarpES_debug_objsdir),, $@))), $(TigerWarpES_cfiles))))).debug.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(TigerWarpES_debug_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(TigerWarpES_debug_objsdir),, $@))), $(TigerWarpES_cfiles))))).debug.P; \
	  rm -f $(TigerWarpES_debug_DEPDIR).d
...
TigerWarpES_release_hpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/4.8/include
TigerWarpES_release_hpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/4.8/libs/armeabi-v7a/include
TigerWarpES_release_hpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/4.8/include/backward
...
TigerWarpES_release_lpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/4.8/libs/armeabi-v7a
TigerWarpES_release_lpaths    += ./../../../extensions/externals/lib/Tegra-Android
TigerWarpES_release_lpaths    += ./../../../extensions/lib/Tegra-Android
...
TigerWarpES_release_cflags  += -fpic -fPIC -ffunction-sections -funwind-tables -fstack-protector -no-canonical-prefixes -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fstrict-aliasing -funswitch-loops -finline-limit=300
...
TigerWarpES_release_cppflags  += -fpic -fPIC -ffunction-sections -funwind-tables -fstack-protector -no-canonical-prefixes -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fstrict-aliasing -funswitch-loops -finline-limit=300
TigerWarpES_release_cppflags  += -funwind-tables -O2 -fno-omit-frame-pointer
...
$(TigerWarpES_release_bin): $(TigerWarpES_release_obj) build_cg4cpp_release build_Half_release build_NvAppBase_release build_NvAssetLoader_release build_NvEGLUtil_release build_NvGamepad_release build_NvGLUtils_release build_NvModel_release build_NvUI_release 
	mkdir -p `dirname ./../../nvpr/TigerWarpES/libs/armeabi-v7a/libTigerWarpES.so`
	$(CXX) -shared $(TigerWarpES_release_obj) $(TigerWarpES_release_lflags) -lc -o $@ 
	$(ECHO) building $@ complete!
...
$(TigerWarpES_release_cpp_o): $(TigerWarpES_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(TigerWarpES_release_objsdir),, $@))), $(TigerWarpES_cppfiles))))))
	cp $(TigerWarpES_release_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(TigerWarpES_release_objsdir),, $@))), $(TigerWarpES_cppfiles))))).release.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(TigerWarpES_release_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(TigerWarpES_release_objsdir),, $@))), $(TigerWarpES_cppfiles))))).release.P; \
...
$(TigerWarpES_release_c_o): $(TigerWarpES_release_objsdir)/%.o:
	...
	mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(TigerWarpES_release_objsdir),, $@))), $(TigerWarpES_cfiles))))))
	cp $(TigerWarpES_release_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(TigerWarpES_release_objsdir),, $@))), $(TigerWarpES_cfiles))))).release.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(TigerWarpES_release_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(TigerWarpES_release_objsdir),, $@))), $(TigerWarpES_cfiles))))).release.P; \
	  rm -f $(TigerWarpES_release_DEPDIR).d
